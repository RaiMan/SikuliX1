...
public class SXDialog extends JFrame {
  ...
  enum FEATURE {ERROR, CLOSE, LINK, IMAGE, ACTION, OPTION, BUTTON, HTML, PREFIX, TEXT, BOX, BOXV}
  ...
  enum ITEMTYPE {SINGLE, LEFT, RIGHT, CENTER, TOP, BOTTOM}
  //endregion
