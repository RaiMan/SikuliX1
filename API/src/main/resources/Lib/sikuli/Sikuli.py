...
OEM_TESSERACT_ONLY = TextOCR.OcrEngineMode.OEM_TESSERACT_ONLY
OEM_LSTM_ONLY = TextOCR.OcrEngineMode.OEM_LSTM_ONLY
OEM_TESSERACT_LSTM_COMBINED = TextOCR.OcrEngineMode.OEM_TESSERACT_LSTM_COMBINED
OEM_DEFAULT = TextOCR.OcrEngineMode.OEM_DEFAULT

PSM_OSD_ONLY =  TextOCR.PageSegMode.PSM_OSD_ONLY
PSM_AUTO_OSD =  TextOCR.PageSegMode.PSM_AUTO_OSD
PSM_AUTO_ONLY =  TextOCR.PageSegMode.PSM_AUTO_ONLY
PSM_AUTO =  TextOCR.PageSegMode.PSM_AUTO
PSM_SINGLE_COLUMN =  TextOCR.PageSegMode.PSM_SINGLE_COLUMN
PSM_SINGLE_BLOCK_VERT_TEXT =  TextOCR.PageSegMode.PSM_SINGLE_BLOCK_VERT_TEXT
PSM_SINGLE_BLOCK =  TextOCR.PageSegMode.PSM_SINGLE_BLOCK
PSM_SINGLE_LINE =  TextOCR.PageSegMode.PSM_SINGLE_LINE
PSM_SINGLE_WORD =  TextOCR.PageSegMode.PSM_SINGLE_WORD
PSM_CIRCLE_WORD =  TextOCR.PageSegMode.PSM_CIRCLE_WORD
PSM_SINGLE_CHAR =  TextOCR.PageSegMode.PSM_SINGLE_CHAR
PSM_SPARSE_TEXT =  TextOCR.PageSegMode.PSM_SPARSE_TEXT
PSM_SPARSE_TEXT_OSD =  TextOCR.PageSegMode.PSM_SPARSE_TEXT_OSD
PSM_COUNT =  TextOCR.PageSegMode.PSM_COUNT
