...
OEM_TESSERACT_ONLY = OCR.OcrEngineMode.TESSERACT_ONLY
OEM_LSTM_ONLY = OCR.OcrEngineMode.LSTM_ONLY
OEM_TESSERACT_LSTM_COMBINED = OCR.OcrEngineMode.TESSERACT_LSTM_COMBINED
OEM_DEFAULT = OCR.OcrEngineMode.DEFAULT

PSM_OSD_ONLY =  OCR.PageSegMode.OSD_ONLY
PSM_AUTO_OSD =  OCR.PageSegMode.AUTO_OSD
PSM_AUTO_ONLY =  OCR.PageSegMode.AUTO_ONLY
PSM_AUTO =  OCR.PageSegMode.AUTO
PSM_SINGLE_COLUMN =  OCR.PageSegMode.SINGLE_COLUMN
PSM_SINGLE_BLOCK_VERT_TEXT =  OCR.PageSegMode.SINGLE_BLOCK_VERT_TEXT
PSM_SINGLE_BLOCK =  OCR.PageSegMode.SINGLE_BLOCK
PSM_SINGLE_LINE =  OCR.PageSegMode.SINGLE_LINE
PSM_SINGLE_WORD =  OCR.PageSegMode.SINGLE_WORD
PSM_CIRCLE_WORD =  OCR.PageSegMode.CIRCLE_WORD
PSM_SINGLE_CHAR =  OCR.PageSegMode.SINGLE_CHAR
PSM_SPARSE_TEXT =  OCR.PageSegMode.SPARSE_TEXT
PSM_SPARSE_TEXT_OSD =  OCR.PageSegMode.SPARSE_TEXT_OSD
PSM_RAW_LINE =  OCR.PageSegMode.RAW_LINE
